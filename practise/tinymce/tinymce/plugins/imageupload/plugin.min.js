                        ...
                        <div class="imageUploadContainerInner">\
                            ...
                            <div class="mce-container imageUploadFormContainer" hidefocus="1" tabindex="-1">\
                                <div class="mce-container-body">\
                                    ...
                                    <input type="hidden" value="" name="csrfmiddlewaretoken" id="csrfmiddlewaretoken">\
                                    <input type="hidden" value="1" name="tinymce">\
                                </div>\
                        ...
                        success: function(response){
                            if (typeof response != "object" || response == null || typeof response.status == 'undefined') {
                                ...
                                if (response.status != 0) {
                                    showImageUploadError(response.detail);
                                }
                                else {
                                    if (typeof response.path != 'undefined') {
                                        var tpl = '<img src="%s" width="100%"/>';
